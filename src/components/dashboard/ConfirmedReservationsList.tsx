...
interface ConfirmedReservationsListProps {
  ...
  onUpdate?: () => void; // passed down from the dashboard to refresh data after completion
}

const ConfirmedReservationsList = ({ reservations, onUpdate }: ConfirmedReservationsListProps) => {
